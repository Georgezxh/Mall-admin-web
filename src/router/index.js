...
export const constantRouterMap = [
  ...
  {path: '/404', component: () => import('@/views/404'), hidden: true},
  {
    ...
    children: [{
      ...
      //   meta: {title: 'Study Tutorials', icon: 'document'}
      // },
      // {
      //   path: 'menu',
      //   name: 'menu',
...
export const asyncRouterMap = [
  {
    ...
    children: [{
      ...
      },
      {
        ...
        meta: {title: 'Product Classification', icon: 'product-cate'}
      },
      {
        path: 'addProductCate',
        name: 'addProductCate',
  ...
  },
  {
    ...
    redirect: '/sms/coupon',
    name: 'sms',
    meta: {title: 'Market', icon: 'sms'},
    children: [
      {
        path: 'flash',
        name: 'flash',
        component: () => import('@/views/sms/flash/index'),
        meta: {title: 'Spike Event List', icon: 'sms-flash'}
      },
      {
        path: 'flashSession',
        name: 'flashSession',
        component: () => import('@/views/sms/flash/sessionList'),
        meta: {title: 'Seconds time slots list'},
        hidden:true
      },
      {
        path: 'selectSession',
        ...
        meta: {title: 'Seconds time slot selection'},
        hidden:true
      },
      {
      ...
      },
      {
        ...
        meta: {title: 'New Products', icon: 'sms-new'}
      },
      {
        path: 'hot',
        name: 'homeHot',
        component: () => import('@/views/sms/hot/index'),
        meta: {title: 'Popularity Recommendation', icon: 'sms-hot'}
      },
      {
        path: 'subject',
        name: 'homeSubject',
        component: () => import('@/views/sms/subject/index'),
        meta: {title: 'Featured', icon: 'sms-subject'}
      },
      {
        path: 'advertise',
        name: 'homeAdvertise',
        component: () => import('@/views/sms/advertise/index'),
        meta: {title: 'Advertisement List', icon: 'sms-ad'}
      },
      {
        path: 'addAdvertise',
        name: 'addHomeAdvertise',
        component: () => import('@/views/sms/advertise/add'),
        meta: {title: 'Add Advertisement'},
        hidden:true
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {title: 'Character List', icon: 'ums-role'}
      },
      {
        path: 'allocMenu',
        name: 'allocMenu',
        component: () => import('@/views/ums/role/allocMenu'),
        meta: {title: 'Assignment menu'},
        hidden: true
      },
      {
        path: 'allocResource',
        ...
        meta: {title: 'Segment performance'},
        hidden: true
      },
      // {
      //   path: 'menu',
