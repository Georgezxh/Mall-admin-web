<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <span style="margin-top: 5px">Data sheet</span>
      <el-button
        class="btn-add"
        @click="handleAddMenu()"
        size="mini">
    ...
    <div class="table-container">
      <el-table ref="menuTable"
        ...
        <el-table-column label="Menu Levels" width="100" align="center">
          <template slot-scope="scope">{{scope.row.level | levelFilter}}</template>
        </el-table-column>
        <el-table-column label="Front-end name" align="center">
          <template slot-scope="scope">{{scope.row.name}}</template>
        </el-table-column>
        <el-table-column label="Front-end Icons" width="100" align="center">
        ...
        <el-table-column label="Setting" width="120" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="text"
        ...
        <el-table-column label="Operational" width="200" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              type="text"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete this menu', 'Tips', {
