  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Input Search：">
            <el-input v-model="listQuery.keyword" class="input-width" placeholder="Character name" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="Character name" align="center">
        ...
        <el-table-column label="Enable or disable" width="140" align="center">
        ...
        <el-table-column label="Operational" width="160" align="center">
          <template slot-scope="scope">
            <el-row>
              <el-button size="mini"
                         type="text"
                         @click="handleSelectMenu(scope.$index, scope.row)">Assignment menu
              </el-button>
              <el-button size="mini"
                         type="text"
                         @click="handleSelectResource(scope.$index, scope.row)">Segment performance
              </el-button>
            </el-row>
            <el-row>
            <el-button size="mini"
    ...
    <el-dialog
      :title="isEdit?'Editorial roles':'Add Role'"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the role?', 'Tips', {
          confirmButtonText: 'Recognize',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
