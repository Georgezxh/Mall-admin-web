<template> 
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Source Category：">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleShowCategory()">Source Category</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="resourceTable"
        ...
        <el-table-column label="Descriptions" align="center">
          <template slot-scope="scope">{{scope.row.description}}</template>
        </el-table-column>
        <el-table-column label="Add Time" width="160" align="center">
          <template slot-scope="scope">{{scope.row.createTime | formatDateTime}}</template>
        </el-table-column>
        <el-table-column label="Operational" width="140" align="center">
    ...
    <el-dialog
      :title="isEdit?'Editorial resources':'Add Resources'"
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the resource?', 'Tips', {
