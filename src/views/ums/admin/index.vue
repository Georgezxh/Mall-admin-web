<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Input Search：">
            <el-input v-model="listQuery.keyword" class="input-width" placeholder="Account Number/Name" clearable></el-input>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
      ...
      <el-table ref="adminTable"
        ...
        <el-table-column label="operational" width="180" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
                       @click="handleSelectRole(scope.$index, scope.row)">Assignment of roles
            </el-button>
            <el-button size="mini"
                       type="text"
    ...
    <el-dialog
      :title="isEdit?'Editorial user':'Add user'"
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleAllocDialogConfirm()" size="small">Recognize</el-button>
      </span>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the user?', 'Tips', {
          confirmButtonText: 'Recognize',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      handleAllocDialogConfirm(){
        this.$confirm('To confirm or not to confirm?', 'Tips', {
          ...
          allocRole(params).then(response => {
            this.$message({
              message: 'Successful distribution！',
              type: 'success'
            });
