  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Order Sorting：">
    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="Payment Methods" width="120" align="center">
    ...
    <el-dialog
      ...
      <span style="vertical-align: top">Operational Remarks：</span>
      <el-input
        style="width: 80%"
        type="textarea"
        :rows="5"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleCloseOrderConfirm">Recognize</el-button>
      </span>
    </el-dialog>
  ...
  data() {
    return {
      ...
      statusOptions: [
        ...
        {
          label: 'Shipment has been dispatched',
          value: 2
        },
        {
          label: 'Completed',
  ...
  methods: {
    ...
    handleBatchOperate(){
      ...
      if(this.operateType===1){
        ...
        if(list.length===0){
          this.$message({
            message: 'Check orders that are not ready to ship',
            type: 'warning',
            duration: 1000
          });
          return;
    ...
    handleCloseOrderConfirm() {
      if (this.closeOrder.content == null || this.closeOrder.content === '') {
        this.$message({
          message: 'Action notes cannot be empty',
          type: 'warning',
          duration: 1000
        });
        return;
