  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Processing state：">
            <el-select v-model="listQuery.status" placeholder="Full" clearable class="input-width">
          ...
          <el-form-item label="Operator:">
            <el-input v-model="listQuery.handleMan" class="input-width" placeholder="Full"></el-input>
          </el-form-item>
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="Service order number" width="180" align="center">
          <template slot-scope="scope">{{scope.row.id}}</template>
        </el-table-column>
        <el-table-column label="Application Time" width="180" align="center">
        ...
        <el-table-column label="Operation" width="180" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              @click="handleViewDetail(scope.$index, scope.row)">View Details</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
