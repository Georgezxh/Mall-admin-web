...
<!--        退货商品-->
      ...
      <el-table
        ...
        ref="productTable"
        :data="productList">
        <el-table-column label="Product Images" width="160" align="center">
        ...
        <el-table-column label="Product Name" align="center">
          <template slot-scope="scope">
            ...
            <span class="font-small">Branding：{{scope.row.productBrand}}</span>
          </template>
        </el-table-column>
        <el-table-column label="Price/No." width="180" align="center">
          <template slot-scope="scope">
            <span class="font-small">Prices：SG{{scope.row.productRealPrice}}</span><br>
            <span class="font-small">Item number：NO.{{scope.row.productId}}</span>
          </template>
        </el-table-column>
        <el-table-column label="Causality" width="180" align="center">
          <template slot-scope="scope">{{scope.row.productAttr}}</template>
        </el-table-column>
        <el-table-column label="Quantities" width="100" align="center">
      ...
      <div style="float:right;margin-top:15px;margin-bottom:15px">
        <span class="font-title-medium">Add up the total：</span>
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18" style="height:50px">
            ...
            <el-button type="text" size="small" @click="handleViewOrder">Check Out</el-button>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Associates</el-col>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Description of the problem</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.description}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:100px;line-height:80px">Voucher Images
          </el-col>
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Confirmation of refund amount
          </el-col>
        ...
        <div v-show="orderReturnApply.status!==3">
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Select Point of Delivery
            </el-col>
            <el-col class="form-border font-small" style="height:52px" :span="18">
          ...
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6">Name of consignee</el-col>
          ...
          <el-row>
            <el-col class="form-border form-left-bg font-small" :span="6">Full Address</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status!==0">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Processors</el-col>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Remarks on processing</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===2">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Person receiving goods</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.receiveMan}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" >Delivery time</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===0">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Remarks on processing</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===1">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Receiving Remarks</el-col>
          <el-col class="form-border font-small" :span="18">
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0">
        <el-button type="primary" size="small" @click="handleUpdateStatus(1)">Confirmation of return</el-button>
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">Refusal of return</el-button>
      </div>
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===1">
        <el-button type="primary" size="small" @click="handleUpdateStatus(2)">Confirmation of receipt of goods</el-button>
      </div>
    </el-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleUpdateStatus(status){
      ...
      this.$confirm('Are you going to perform this operation?', 'Tips', {
