<template> 
  <div class="app-container">
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleSelectBrand()">Select Brand</el-button>
    </el-card>
    <div class="table-container">
      <el-table ref="homeBrandTable"
        ...
        <el-table-column label="State of affairs" width="160" align="center">
    ...
    <el-dialog title="Select Brand" :visible.sync="selectDialogVisible" width="40%">
      ...
      <el-table :data="dialogData.list"
        ...
        <el-table-column label="Correlation" width="220" align="center">
          <template slot-scope="scope">
            Product：<span class="color-main">{{scope.row.productCount}}</span>
            Estimation：<span class="color-main">{{scope.row.productCommentCount}}</span>
          </template>
        </el-table-column>
      </el-table>
      <div class="pagination-container">
