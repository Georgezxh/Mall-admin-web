  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productRelationTable"
        ...
        <el-table-column label="Spike count" width="100" align="center">
        ...
        <el-table-column label="Operational" width="100" align="center">
          <template slot-scope="scope">
            <el-button size="mini"
                       type="text"
    ...
    <el-dialog title="Edit product information"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleEditDialogConfirm()" size="small">Recognize</el-button>
      </span>
    </el-dialog>
  </div>
</template>
