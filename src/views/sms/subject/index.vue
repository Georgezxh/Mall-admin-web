  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Topic title：">
            <el-input v-model="listQuery.subjectName" class="input-width" placeholder="Topic title"></el-input>
          </el-form-item>
    ...
    <el-dialog title="Select Topic" :visible.sync="selectDialogVisible" width="50%">
      ...
      <el-table :data="dialogData.list"
        ...
        <el-table-column label="Subsidiary Classification" width="160" align="center">
