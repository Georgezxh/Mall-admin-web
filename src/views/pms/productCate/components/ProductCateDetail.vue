<template>
  <el-card class="form-container" shadow="never">
    <el-form :model="productCate"
      ...
      <el-form-item>
        <el-button size="small" type="primary" @click="handleAddFilterAttr()">Additional</el-button>
      </el-form-item>
    ...
    methods: {
      getSelectProductCateList() {
        fetchList(0, {pageSize: 100, pageNum: 1}).then(response => {
          ...
          this.selectProductCateList.unshift({id: 0, name: 'No higher classification'});
        });
      },
      ...
      handleAddFilterAttr() {
        if (this.filterProductAttrList.length === 3) {
          this.$message({
            message: 'Add a maximum of three',
            type: 'warning',
            duration: 1000
          });
          return;
