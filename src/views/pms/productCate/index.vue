  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productCateTable"
        ...
        <el-table-column label="Classification name" align="center">
        ...
        <el-table-column label="Unit of quantity" width="100" align="center">
        ...
        <el-table-column label="Setting" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              size="mini"
              @click="handleTransferProduct(scope.$index, scope.row)">Transfer of commodities
            </el-button>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the brand', 'Tips', {
