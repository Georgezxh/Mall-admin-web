<template> 
  <el-card class="form-container" shadow="never">
    <el-form :model="brand" :rules="rules" ref="brandFrom" label-width="150px">
      <el-form-item label="Brand names：" prop="name">
      ...
      <el-form-item label="Brand area large map：">
      ...
      <el-form-item label="Arrange in order：" prop="sort">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        logo: [
          {required: true, message: 'Please enter your brand logo', trigger: 'blur'}
        ],
        sort: [
          {type: 'number', message: 'Sorting must be numeric'}
        ],
      }
    }
  },
