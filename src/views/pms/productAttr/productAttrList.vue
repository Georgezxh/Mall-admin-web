  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="Attribute value entry method" width="150" align="center">
          <template slot-scope="scope">{{scope.row.inputType|inputTypeFilter}}</template>
        </el-table-column>
        <el-table-column label="List of available values" align="center">
  ...
  export default {
    ...
    methods: {
      ...
      handleDeleteProductAttr(ids) {
        this.$confirm('Whether to delete the property', 'Tips', {
