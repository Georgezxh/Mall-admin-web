    ...
    <el-form :model="productAttr" :rules="rules" ref="productAttrFrom" label-width="150px">
      ...
      <el-form-item label="Whether the attribute is optional:">
        <el-radio-group v-model="productAttr.selectType">
          ...
          <el-radio :label="2">Reelection</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="Attribute Value Entry Methods:">
      ...
      <el-form-item label="Sort Properties：">
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          name: [
            {required: true, message: 'Please enter a property name', trigger: 'blur'},
