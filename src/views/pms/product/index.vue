  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Product Number：">
            <el-input style="width: 203px" v-model="listQuery.productSn" placeholder="Product Number"></el-input>
          </el-form-item>
          ...
          <el-form-item label="Product Brands：">
            <el-select v-model="listQuery.brandId" placeholder="Please select brand" clearable>
              <el-option
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="Audit Status" width="100" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.verifyStatus | verifyStatusFilter}}</p>
            <p>
              <el-button
                type="text"
                @click="handleShowVerifyDetail(scope.$index, scope.row)">Audit Details
              </el-button>
            </p>
          </template>
        </el-table-column>
        <el-table-column label="Operation" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <el-button
                size="mini"
                @click="handleShowProduct(scope.$index, scope.row)">Check Out
              </el-button>
              <el-button
                size="mini"
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handleEditSkuConfirm">Recognize</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      operates: [
        ...
        {
          label: "Products off the shelves",
          value: "publishOff"
        },
        {
      ...
      publishStatusOptions: [{
        ...
        value: 0,
        label: 'Take down from the shelves (e.g. a contaminated product)'
      }],
      verifyStatusOptions: [{
        value: 1,
        label: 'Approved'
  ...
  methods: {
    ...
    handleEditSkuConfirm(){
      ...
      this.$confirm('Whether to make changes', 'Tips', {
    ...
    handleBatchOperate() {
      ...
      this.$confirm('Whether to perform this batch operation?', 'Tips', {
        confirmButtonText: 'Recognize',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
    ...
    handleDelete(index, row){
      this.$confirm('Whether to perform a deletion operation?', 'Tips', {
        confirmButtonText: 'Recognize',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
