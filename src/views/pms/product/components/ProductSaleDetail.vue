<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productSaleForm" label-width="120px" class="form-inner-container" size="small">
      ...
      <el-form-item label="Points Purchase Restrictions：">
        <el-input v-model="value.usePointLimit"></el-input>
      </el-form-item>
      <el-form-item label="Product Forecast：">
        <el-switch
      ...
      <el-form-item label="Service Guarantee：">
        <el-checkbox-group v-model="selectServiceList">
          ...
          <el-checkbox :label="2">Fast Refunds</el-checkbox>
      ...
      <el-form-item label="Product Remarks：">
        <el-input v-model="value.note" type="textarea" :autoSize="true"></el-input>
      </el-form-item>
      <el-form-item label="Choosing Discount：">
        <el-radio-group v-model="value.promotionType" size="small">
          <el-radio-button :label="0">No discount</el-radio-button>
          <el-radio-button :label="1">Special Promotions</el-radio-button>
          <el-radio-button :label="2">Member Prices</el-radio-button>
          <el-radio-button :label="3">Tiered Price</el-radio-button>
          <el-radio-button :label="4">Price Reduction</el-radio-button>
        </el-radio-group>
      </el-form-item>
        ...
        <el-table :data="value.productFullReductionList"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text" @click="handleAddFullReduction(scope.$index, scope.row)">App</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-form-item>
      <el-form-item style="text-align: center">
        ...
        <el-button type="primary" size="medium" @click="handleNext">Next, fill in the product properties</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  methods: {
    ...
    handleAddFullReduction(index, row) {
      ...
      if (fullReductionList.length < 3) {
        ...
        this.$message({
          message: 'Maximum of three items can be added',
          type: 'warning'
        });
      }
    },
