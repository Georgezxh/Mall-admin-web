    ...
    <el-form :model="value"
      ...
      <el-form-item label="Related Topics：">
        <el-transfer
          ...
          filter-placeholder="Please enter topic name"
          v-model="selectSubject"
          :titles="subjectTitles"
          :data="subjectList">
        </el-transfer>
      </el-form-item>
      <el-form-item label="Affiliate Preferences：">
        <el-transfer
          style="display: inline-block"
          filterable
          :filter-method="filterMethod"
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">Previous step, fill in the product attributes</el-button>
        <el-button type="primary" size="medium" @click="handleFinishCommit">Finish, submit goods</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
