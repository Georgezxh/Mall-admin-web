<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" class="form-inner-container" size="small">
      ...
      <el-form-item label="Product Specification：">
      ...
      <el-form-item label="Property Images：" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item label="Product Details：">
        <el-tabs v-model="activeHtmlName" type="card">
          <el-tab-pane label="PC Details" name="pc">
      ...
      <el-form-item style="text-align: center">
        ...
        <el-button type="primary" size="medium" @click="handleNext">Next, select the product association</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  methods: {
    ...
    handleAddProductAttrValue(idx) {
      ...
      if (this.addProductAttrValue == null || this.addProductAttrValue == '') {
        this.$message({
          message: 'Attribute values cannot be null',
          type: 'warning',
          duration: 1000
        });
        return
      ...
      if (options.indexOf(this.addProductAttrValue) !== -1) {
        this.$message({
          message: 'Attribute values cannot be duplicated',
          type: 'warning',
          duration: 1000
        });
        return;
    ...
    handleRefreshProductSkuList() {
      this.$confirm('Refreshing the list will cause the sku information to be regenerated, should it be refreshed?', 'Tips', {
    ...
    handleSyncProductSkuPrice(){
      this.$confirm('Will synchronize the price of the first sku to all sku, continue or not.', 'Tips', {
        confirmButtonText: 'Recognize',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
    ...
    handleSyncProductSkuStock(){
      this.$confirm('Will synchronize the inventory of the first sku to all skus, continue or not.', 'Tips', {
        confirmButtonText: 'Recognize',
        cancelButtonText: 'Cancel',
        type: 'warning'
      }).then(() => {
