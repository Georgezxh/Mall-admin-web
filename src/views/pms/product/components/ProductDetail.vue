<template> 
  <el-card class="form-container" shadow="never">
    <el-steps :active="active" finish-status="success" align-center>
      ...
      <el-step title="Fill in the product attributes"></el-step>
      <el-step title="Select a product association"></el-step>
    </el-steps>
    <product-info-detail
      v-show="showStatus[0]"
...
export default {
  ...
  methods: {
    ...
    finishCommit(isEdit) {
      this.$confirm('Whether to submit this product', 'Tips', {
