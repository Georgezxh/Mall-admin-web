<template>
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" class="form-inner-container" size="small">
      <el-form-item label="Product Classification：" prop="productCategoryId">
        <el-cascader
      ...
      <el-form-item label="Subheading：" prop="subTitle">
        <el-input v-model="value.subTitle"></el-input>
      </el-form-item>
      <el-form-item label="Product Brands：" prop="brandId">
        <el-select
      ...
      <el-form-item label="Merchandise Introduction：">
        <el-input
          :autoSize="true"
      ...
      <el-form-item style="text-align: center">
        <el-button type="primary" size="medium" @click="handleNext('productInfoForm')">Next, fill out the merchandise promotion</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
