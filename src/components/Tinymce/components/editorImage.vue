<template>
  <div class="upload-container">
    <el-button icon='el-icon-upload' size="mini" :style="{background:color,borderColor:color}"
               @click=" dialogVisible=true" type="primary">Upload a picture
    </el-button>
    <el-dialog append-to-body :visible.sync="dialogVisible">
      ...
      <el-button type="primary" @click="handleSubmit">Recognize</el-button>
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (!this.checkAllSuccess()) {
        this.$message('Please wait until all images are uploaded successfully or if there is a network problem, please refresh the page to re-upload.！')
        return
      }
      console.log(arr);
